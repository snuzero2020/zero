...
void Lane::get_coeff()
{
    ...
    inverse_A[0][1] = A[0][3]*A[2][2]*A[3][1]+A[0][2]*A[2][1]*A[3][3]+A[0][1]*A[2][3]*A[3][2]-A[0][1]*A[2][2]*A[3][3]-A[0][2]*A[2][3]*A[3][1]-A[0][3]*A[2][1]*A[3][2];
    inverse_A[0][2] = A[0][1]*A[1][2]*A[3][3]+A[0][2]*A[1][3]*A[3][1]+A[0][3]*A[1][1]*A[3][2]-A[0][3]*A[1][2]*A[3][1]-A[0][2]*A[1][1]*A[3][3]-A[0][1]*A[1][3]*A[3][2];
    inverse_A[0][3] = A[0][3]*A[1][2]*A[2][1]+A[0][2]*A[1][1]*A[2][3]+A[0][1]*A[1][3]*A[2][2]-A[0][1]*A[1][2]*A[2][3]-A[0][2]*A[1][3]*A[2][1]-A[0][3]*A[1][1]*A[2][2];

    inverse_A[1][0] = A[1][3]*A[2][2]*A[3][0]+A[1][2]*A[2][0]*A[3][3]+A[1][0]*A[2][3]*A[3][2]-A[1][0]*A[2][2]*A[3][3]-A[1][2]*A[2][3]*A[3][0]-A[1][3]*A[2][0]*A[3][2];
    ...
    inverse_A[1][2] = A[0][3]*A[1][2]*A[3][0]+A[0][2]*A[1][0]*A[3][3]+A[0][0]*A[1][3]*A[3][2]-A[0][0]*A[1][2]*A[3][3]-A[0][2]*A[1][3]*A[3][0]-A[0][3]*A[1][0]*A[3][2];
    inverse_A[1][3] = A[0][0]*A[1][2]*A[2][3]+A[0][2]*A[1][3]*A[2][0]+A[0][3]*A[1][0]*A[2][2]-A[0][3]*A[1][2]*A[2][0]-A[0][2]*A[1][0]*A[2][3]-A[0][0]*A[1][3]*A[2][2];

    inverse_A[2][0] = A[1][0]*A[2][1]*A[3][3]+A[1][1]*A[2][3]*A[3][0]+A[1][3]*A[2][0]*A[3][1]-A[1][3]*A[2][1]*A[3][0]-A[1][1]*A[2][0]*A[3][3]-A[1][0]*A[2][3]*A[3][1];
    inverse_A[2][1] = A[0][3]*A[2][1]*A[3][0]+A[0][1]*A[2][0]*A[3][3]+A[0][0]*A[2][3]*A[3][1]-A[0][0]*A[2][1]*A[3][3]-A[0][1]*A[2][3]*A[3][0]-A[0][3]*A[2][0]*A[3][1];
    ...
    inverse_A[2][3] = A[0][3]*A[1][1]*A[2][0]+A[0][1]*A[1][0]*A[2][3]+A[0][0]*A[1][3]*A[2][1]-A[0][0]*A[1][1]*A[2][3]-A[0][1]*A[1][3]*A[2][0]-A[0][3]*A[1][0]*A[2][1];

    inverse_A[3][0] = A[1][2]*A[2][1]*A[3][0]+A[1][1]*A[2][0]*A[3][2]+A[1][0]*A[2][2]*A[3][1]-A[1][0]*A[2][1]*A[3][2]-A[1][1]*A[2][2]*A[3][0]-A[1][2]*A[2][0]*A[3][1];
    inverse_A[3][1] = A[0][0]*A[2][1]*A[3][2]+A[0][1]*A[2][2]*A[3][0]+A[0][2]*A[2][0]*A[3][1]-A[0][2]*A[2][1]*A[3][0]-A[0][1]*A[2][0]*A[3][2]-A[0][0]*A[2][2]*A[3][1];
    inverse_A[3][2] = A[0][2]*A[1][1]*A[3][0]+A[0][1]*A[1][0]*A[3][2]+A[0][0]*A[1][2]*A[3][1]-A[0][0]*A[1][1]*A[3][2]-A[0][1]*A[1][2]*A[3][0]-A[0][2]*A[1][0]*A[3][1];
