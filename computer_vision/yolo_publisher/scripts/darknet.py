...
if os.name == "nt":
    ...
    lib = CDLL("/home/snuzero/catkin_ws/src/zero/computer_vision/yolo_publisher/scripts/libdarknet.so", RTLD_GLOBAL)
...
def performDetect(imagePath="/home/snuzero1/darknet/x64/data/obj/pylon_camera_node-000220-1540444604.221.jpg", thresh= 0.25, configPath = "/home/snuzero1/darknet/yolo-obj.cfg", weightPath = "/home/snuzero1/darknet/backup/yolo-obj_last.weights", metaPath= "/home/snuzero1/darknet/x64/data/obj.data", showImage= True, makeImageOnly = False, initOnly= False):
    """
...
def performBatchDetect(thresh= 0.25, configPath = "/home/snuzero1/darknet/yolo-obj.cfg", weightPath = "/home/snuzero1/darknet/backup/yolo-obj_last.weights", metaPath= "/home/snuzero1/darknet/x64/data/obj.data", hier_thresh=.5, nms=.45, batch_size=3):
    import cv2
    import numpy as np
    # NB! Image sizes should be the same
    # You can change the images, yet, be sure that they have the same width and height
    img_samples = ['/home/snuzero1/darknet/x64/data/obj/fmtca0067.jpg', '/home/snuzero1/darknet/x64/data/obj/pylon_camera_node-000110-1540445317.387.jpg', '/home/snuzero1/darknet/x64/data/obj/pylon_camera_node-000180-1540426935.827.jpg']
